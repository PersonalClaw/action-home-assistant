"""CLI seams for action-home-assistant (plan 32): a setup step and a doctor probe.
...
def setup(ctx: SetupContext) -> None:
    ...
    ctx.print("Action Home Assistant: nothing to configure yet.")
